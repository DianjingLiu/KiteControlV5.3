...
#ssssKERNEL_PATH = os.path.join(DIR_PATH, "kernels/kernel_0.bmp")
#KERNEL_PATH = os.path.join(DIR_PATH, "kernels/kernel_1.bmp")

KERNEL_PATH = os.path.join(DIR_PATH, "kernels/kernel_0.bmp")

START_FRAME = None#"F:\\Dropbox\\20180329\\2018-3-29-12-44-9-228-original.bmp" # the path to the start frame name, in case we want to start in the middle of video
...
BG_MODEL_PATH  = os.path.join(DIR_PATH,"model/mlp-bg-py3-5.model")
