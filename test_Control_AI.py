...
Tracker.READ_FROM_FILE = True # For debug. Read image from file
Tracker.DISPLAY = True
Tracker.RECORD_VIDEO = False
Tracker.IMAGE_PATH = 'F:\\GrapV1.13\\Src\\Color\\*.bmp'#'G:\\Dropbox\\20180617\\*.bmp'

# Log file path
CurrentTime = time.time()
CurrentTime = datetime.datetime.fromtimestamp(CurrentTime).strftime('%Y-%m-%d %H-%M-%S')
LOG_PATH = './log/test_track_speed_' + CurrentTime + '_AI{:d}.txt'.format(AI_MODEL)
...
if __name__ == '__main__':
    ...
    while running_flag:
        ...
        if MODE == -1:
            ...
            Wheel_button = WheelControl(joystick)
        elif MODE == 2:
            # Fuzzy logic control
